...
export const ReportCard: React.FC<ReportCardProps> = ({ data, logoUrl }) => {
  ...
  const coreSubjects = ['NUMERACY', 'LITERACY', 'SOCIAL', 'EMOTIONAL', 'SCIENCE', 'SOCIAL STUDIES', 'FRENCH'];
    ...
    <div className="bg-white p-4 max-w-3xl mx-auto w-full text-black font-sans text-sm">
      ...
      <div className="border-4 border-black p-1">
        ...
        <div className="border-b-2 border-black pb-2 mb-2">
           <div className="flex justify-between items-start font-bold uppercase text-xs md:text-sm">
              <div>
        ...
        <div className="border-2 border-black text-center font-bold uppercase py-1 mb-1 text-sm bg-slate-100">
           PERIODIC PROGRESS REPORT academic year: {year}
        </div>
              ...
              <tr>
                 <td className="border border-black p-2 align-top" colSpan={2}>
                    <div className="flex flex-col gap-2">
                      <div className="uppercase underline mb-1">KEY:</div>
                      <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                        <div className="flex items-center gap-2">
                          <span className="w-4 h-4 bg-green-300 border border-green-900 inline-block"></span>
                          <span>90 - 100 (Excellent)</span>
                        </div>
                        <div className="flex items-center gap-2">
                           <span className="w-4 h-4 bg-yellow-300 border border-yellow-900 inline-block"></span>
                           <span>70 - 89 (Very Good)</span>
                        </div>
                        <div className="flex items-center gap-2">
                           <span className="w-4 h-4 bg-pink-300 border border-pink-900 inline-block"></span>
                           <span>60 - 69 (Good)</span>
                        </div>
                        <div className="flex items-center gap-2">
                           <span className="w-4 h-4 bg-red-300 border border-red-900 inline-block"></span>
                           <span>0 - 59 (Fail)</span>
                        </div>
                      </div>
                    </div>
